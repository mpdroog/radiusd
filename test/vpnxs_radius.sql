/*
 ...
 Source Schema         : vpnxs_radius

 Target Server Type    : MySQL
 Target Server Version : 100314
 File Encoding         : 65001

 Date: 15/06/2019 15:06:28
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `product` VALUES (1, 'derp', 1, NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `user` (
  ...
  `active_until` date DEFAULT NULL COMMENT 'Account becomes inactive on given date',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (5, 'vpn293b50c891377b94c904b42396e45fd99d', 'derpderp', 0, NULL, NULL, 1, NULL, 2017, NULL);
COMMIT;
